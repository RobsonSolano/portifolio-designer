<main class="flex-shrink-0">
    ...
    <section class="py-3">
        <div class="container">
            ...
            <!-- Contact form-->
            <div class="bg-<?php echo empty($this->session->userdata('theme_global')) ? 'dark' : $this->session->userdata('theme_global'); ?> rounded-4 py-3 py-md-2 px-4 px-md-5">
                ...
                <div class="row gx-5 justify-content-center">
                    ...
                    <div class="col-12 mb-3">
                        <div class="form-floating ">
                            <?php echo form_input('nome', set_value('nome'), ['class' => !empty($error['nome']) ? 'form-control border-danger' : 'form-control', 'id' => 'name', 'placeholder' => 'Informe seu nome', 'required' => 'required']); ?>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 mb-3">
                        <!-- Email address input-->
                        <div class="form-floating ">
                            <?php echo form_input('email', set_value('email'), ['class' => !empty($error['email']) ? 'form-control border-danger' : 'form-control', 'id' => 'name', 'placeholder' => 'Informe seu email', 'required' => 'required']); ?>
                    ...
                    <div class="col-12 col-sm-12 col-md-6  mb-3">
                        <!-- Phone number input-->
                        <div class="form-floating">
                            <?php echo form_input('celular', set_value('celular'), ['class' => !empty($error['celular']) ? 'form-control border-danger' : 'form-control', 'id' => 'phone', 'placeholder' => '(##) #####-####', 'required' => 'required', 'attrname' => 'maskphone']); ?>
                    ...
                    <div class="col-12  mb-3">
                        <!-- Message input-->
                        <div class="form-floating">
                            <textarea class="<?php echo !empty($error['mensagem']) ? 'form-control border-danger' : 'form-control'; ?>" minlength="20" id="message" name="mensagem" type="text" placeholder="Informe sua mensagem"
